...
//======================================================================================//
//								General Functions		passed window							    //
//=====================================================================================//
...
{	
	...
	else	
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			//case ITM_Dice_Value: return Dice_Value;		Change Name if it is defferent
		...
		//return TO_DESIGN_MODE;	// just for now ==> This should be updated  Now It's From Click
